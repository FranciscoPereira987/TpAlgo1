...
def crear_csv():
    ...
    cant_return = cantidad_de([' ret' + 'urn '])        
    cant_if = cantidad_de([' i' + 'f ',' el' + 'if '])
    cant_for = cantidad_de([' fo' + 'r '])
    cant_while = cantidad_de([' whi' + 'le '])
    cant_break = cantidad_de([' br' + 'eak '])
    cant_exit = cantidad_de([' ex'+'it '])   
